...
const getWeatherData = async (zipcode) => {
    ...
    //return the values
    return {name, high, low, humidity, forecast, description}
}
...
const getBackgroundImage = (forecast) => {
    const backgroundImage = forecastImages[forecast]
...
submitBtn.addEventListener('click', () => {
    // get the zipcode
    const zipcode = document.querySelector('#floatingInput').value
